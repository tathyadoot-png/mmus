...
<motion.div initial={{ y: "100%" }} animate={{ y: 0 }} exit={{ y: "100%" }} transition={{ type: "spring", damping: 25 }} className="bg-white w-full min-h-screen overflow-y-auto pb-24 absolute inset-0 z-[10005]">
  ...
  <div className="max-w-4xl mx-auto px-6 py-16">
    ...
    <div className="prose prose-lg max-w-none text-slate-700 space-y-6 font-medium leading-[1.8]">
      ...
      <p>प्रेस वार्ता में समिति के अध्यक्ष एवं मध्य प्रदेश सरकार के पूर्व मंत्री <strong>श्री उमाशंकर गुप्ता जी</strong> तथा मेला संयोजक <strong>श्री प्रदीप मिश्र जी</strong> ने मेले की रूपरेखा, उद्देश्य एवं प्रमुख आकर्षणों की विस्तृत जानकारी साझा की। इस प्रेस वार्ता में मेला सहसंयोजक वैभव सिंह सिसोदिया, उपाध्यक्ष सुशील वासवानी, कोषाध्यक्ष राकेश जोशी, उपाध्यक्ष चेतन सिंह व अमित अग्रवाल, महासचिव अजय अग्रवाल मौजूद रहे।</p>
